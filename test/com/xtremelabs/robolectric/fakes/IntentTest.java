...
public class IntentTest {
    ...
    public void setUp() throws Exception {
        RobolectricAndroidTestRunner.addProxy(Intent.class, FakeIntent.class);
        RobolectricAndroidTestRunner.addProxy(ComponentName.class, FakeComponentName.class);
    }
    ...
    public void testStringExtra() throws Exception {
        ...
        FakeIntent fakeIntent = (FakeIntent) RobolectricAndroidTestRunner.proxyFor(intent);
    ...
    public void testLongExtra() throws Exception {
        ...
        assertEquals(2L, ((FakeIntent) RobolectricAndroidTestRunner.proxyFor(intent)).extras.get("foo"));
    }
