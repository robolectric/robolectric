...
public @interface LooperMode {
  ...
  enum Mode {
     ...
     *
     * <ol>
     *   <li>The default {@link IdleState#UNPAUSED} will executed tasks posted to a {@link
     *       android.os.Looper} inline synchronously. This differs from real Android behaviour, and
     *       can cause issues with code that expects/enforces that posted tasks execute in the
     *       correct order, such as RecyclerViews.
     ...
     * </ul>
     *
     * <p>However, it has the following improvements:
     *
     * <ul>
     ...
     * </ul>
     *
     * <p>A subset of the {@link org.robolectric.util.Scheduler} APIs for the 'foreground' scheduler
