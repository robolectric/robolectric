...
class ResourceParser {
  static void load(String packageName, ResourcePath resourcePath, PackageResourceTable resourceTable) {
    ...
    final ResBunch data = resourceTable.data;
    ...
    DocumentLoader documentLoader = new DocumentLoader(packageName, resourcePath,
        ...
        new ArrayResourceLoader(data, "/resources/integer-array", "array", ResType.INTEGER_ARRAY),
        ...
        new ArrayResourceLoader(data, "/resources/string-array", "array", ResType.CHAR_SEQUENCE),
