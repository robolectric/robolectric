...
class MavenRoboSettingsTest {
    ...
    private lateinit var originalMavenRepositoryId: String
    private lateinit var originalMavenRepositoryUrl: String
    private lateinit var originalMavenRepositoryUserName: String
    private lateinit var originalMavenRepositoryPassword: String
