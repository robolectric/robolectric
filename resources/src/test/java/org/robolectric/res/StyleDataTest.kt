  ...
  fun getAttrValue_willFindLibraryResourcesWithSameName() {
    val styleData =
      StyleData(
        ...
        "Theme_MyApp",
        "Theme_Material",
        Arrays.asList(AttributeResource(myLibSearchViewStyle, "lib_value", "library.resource"))
      )
  ...
  fun attrValue_willNotFindFrameworkResourcesWithSameName() {
    val styleData =
      StyleData(
        ...
        "Theme_Material",
        "Theme",
        Arrays.asList(AttributeResource(androidSearchViewStyle, "android_value", "android"))
      )
  ...
  fun attrValue_willReturnTrimmedAttributeValues() {
    val styleData =
      StyleData(
        ...
        "Theme_MyApp",
        "Theme_Material",
        Arrays.asList(AttributeResource(myLibSearchViewStyle, "\n lib_value ", "library.resource"))
      )
