    ...
    while (current != null && current != Any::class.java) {
      if (
        current.declaredMethods.any { method ->
          method.isAnnotationPresent(BeforeClass::class.java) ||
            method.isAnnotationPresent(AfterClass::class.java) ||
            method.isAnnotationPresent(BeforeAll::class.java) ||
            method.isAnnotationPresent(AfterAll::class.java)
        }
      ) {
        return true
      }
