...
internal object JupiterDescriptorBuilders {
   ...
   *
   * Note: unlike [org.robolectric.junit.platform.PlatformDescriptorBuilders], this builder does not
   * currently emit per-SDK variant descriptors for multi-SDK discovery
   * (`-Drobolectric.enabledSdks`). The Jupiter engine runs a single SDK per method, chosen via
   * [org.robolectric.runner.common.SdkFallbackResolver]. Multi-SDK discovery parity is a known gap
   * — see runner/common/docs/runner-design.md.
   */
