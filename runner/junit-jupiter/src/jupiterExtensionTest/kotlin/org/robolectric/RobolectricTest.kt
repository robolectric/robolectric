...
class RobolectricTest {
  ...
  // Lazy: Jupiter constructs a placeholder instance on the application classloader where no
  // instrumentation is registered; only the sandbox-loaded twin may touch Android APIs.
