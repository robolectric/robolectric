...
data class RobolectricDependencies(
  ...
  val methodHandleDecorators: List<MethodHandleDecorator>,
  ...
  companion object {
    ...
    fun create(
      ...
      frameworkClassLoadingBridge: FrameworkClassLoadingBridge = DefaultFrameworkClassLoadingBridge,
      ...
      return RobolectricDependencies(
        ...
        frameworkClassLoadingBridge = frameworkClassLoadingBridge,
      )
    }
  }
}
