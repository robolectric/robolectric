...
**Purpose**: Utilities for test discovery (JUnit Platform specific).
...
| `appendTestClass()` | `parent: TestDescriptor, testClass: Class<*>, isTestMethod: (Method) -> Boolean, nestedAnnotation: Class<out Annotation>?` | `Unit` | Not thread-safe |
| `appendTestMethod()` | `parent: TestDescriptor, testClass: Class<*>, method: Method` | `Unit` | Not thread-safe |

**Supported Test Annotations**:
- `org.junit.jupiter.api.Test`
- `org.junit.Test`
- `io.kotest.core.annotation.Test`
