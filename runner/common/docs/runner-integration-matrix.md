...
| `DiscoveryHelpers` | Build test descriptor tree |
...
1. Use `DiscoveryHelpers` for consistent test discovery
2. Support both `@org.junit.Test` and `@org.junit.jupiter.api.Test`
3. Handle SDK parameterization in discovery phase
