...
// Including for Robolectric 2.0; taken from android-4.2.2_r1.2.
// todo: add this to android-luni jar instead
...
public abstract class UriCodec {
  ...
  public final void appendEncoded(StringBuilder builder, String s) {
    appendEncoded(builder, s, FakeCharsets.UTF_8, false);
  }

  public final void appendPartiallyEncoded(StringBuilder builder, String s) {
    appendEncoded(builder, s, FakeCharsets.UTF_8, true);
  }
  ...
  public static String decode(String s) {
    return decode(s, false, FakeCharsets.UTF_8, true);
  }
