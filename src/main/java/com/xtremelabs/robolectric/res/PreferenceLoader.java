...
public class PreferenceLoader extends XmlLoader {
	...
	public PreferenceLoader(ResourceExtractor resourceExtractor, AttrResourceLoader attrResourceLoader) {
	...
	public class PreferenceNode {
		...
		private Preference constructPreference(Context context, PreferenceGroup parent) throws Exception {
			...
			try {
				TestAttributeSet attributeSet = new TestAttributeSet(attributes, resourceExtractor, attrResourceLoader, null, false);
