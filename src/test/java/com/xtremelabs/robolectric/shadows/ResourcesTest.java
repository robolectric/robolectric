...
public class ResourcesTest {
    ...
    @Test
    public void settingDensityWillChangeValueInExistingDisplayMetricsInstance() throws Exception {
        DisplayMetrics displayMetrics = resources.getDisplayMetrics();
        assertThat(displayMetrics.density, equalTo(1.0f));
        Robolectric.setDisplayMetricsDensity(2f);
        assertThat(displayMetrics.density, equalTo(2f));
    }
}
