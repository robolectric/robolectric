...
public class GetInstallerPackageNameModeConfigurer implements Configurer<GetInstallerPackageNameMode.Mode>  {
  ...
  public GetInstallerPackageNameMode.Mode merge(
      @Nonnull GetInstallerPackageNameMode.Mode parentConfig, @Nonnull GetInstallerPackageNameMode.Mode childConfig) {
    // just take the childConfig - since GetInstallerPackageNameMode only has a single 'value'
    // attribute
    return childConfig;
  }

  private GetInstallerPackageNameMode.Mode valueFrom(GetInstallerPackageNameMode looperMode) {
