...
import android.support.test.internal.platform.InjectEventSecurityException;
import android.support.test.internal.platform.UiController;
...
public class RoboUiController implements UiController {
  ...
  private static List<ViewRootImpl> getViewRoots() {
    ...
    if (ViewRootImpl[].class.isAssignableFrom(viewRootsClass)) {
      ...
      throw new IllegalStateException("WindowManager.mRoots is an unknown type "
          + viewRootsClass.getName());
    }
  }
