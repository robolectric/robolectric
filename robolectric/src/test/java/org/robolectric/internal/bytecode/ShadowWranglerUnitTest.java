...
import org.robolectric.AndroidInstrumentationConfigurer;
...
public class ShadowWranglerUnitTest {
  private Wrangler shadowWrangler;

  @Before
  public void setup() throws Exception {
    shadowWrangler = new Wrangler(ShadowMap.EMPTY, 23);
  }
  ...
  public void getInterceptionHandler_whenInterceptingElderOnLinkedHashMap_shouldReturnNonDoNothingHandler() throws Exception {
    ...
    assertThat(handler).isNotSameAs(Wrangler.DO_NOTHING_HANDLER);
  }
  ...
  public void shadowClassWithSdkRange() throws Throwable {
    ...
    assertThat(new Wrangler(shadowMap, 18).methodInvoked(methodName, false, DummyClass.class)).isNull();
    assertThat(new Wrangler(shadowMap, 19).methodInvoked(methodName, false, DummyClass.class).describe())
        .contains("ShadowDummyClass.methodWithoutRange()");
    assertThat(new Wrangler(shadowMap, 23).methodInvoked(methodName, false, DummyClass.class)).isNull();
  }
  ...
  public void shadowMethodWithSdkRange() throws Throwable {
    ...
    assertThat(new Wrangler(shadowMap, 19).methodInvoked(methodName, false, DummyClass.class)).isNull();
    assertThat(new Wrangler(shadowMap, 20).methodInvoked(methodName, false, DummyClass.class).describe())
        .contains("ShadowDummyClass.methodFor20()");
    assertThat(new Wrangler(shadowMap, 21).methodInvoked(methodName, false, DummyClass.class)).isNull();
  }
  ...
  public void shadowMethodWithMinSdk() throws Throwable {
    ...
    assertThat(new Wrangler(shadowMap, 21).methodInvoked(methodName, false, DummyClass.class).describe())
        .contains("ShadowDummyClass.methodMin20()");
  }
  ...
  public void whenChildShadowHasNarrowerSdk_createShadowFor_shouldReturnSuperShadowSometimes() throws Exception {
    ...
    assertThat(new Wrangler(shadowMap, 18).createShadowFor(new ChildOfDummyClass()))
        .isSameAs(Wrangler.NO_SHADOW);
    assertThat(new Wrangler(shadowMap, 19).createShadowFor(new ChildOfDummyClass()))
        .isInstanceOf(ShadowDummyClass.class);
    assertThat(new Wrangler(shadowMap, 20).createShadowFor(new ChildOfDummyClass()))
        .isInstanceOf(ShadowChildOfDummyClass.class);
    assertThat(new Wrangler(shadowMap, 21).createShadowFor(new ChildOfDummyClass()))
        .isInstanceOf(ShadowChildOfDummyClass.class);
    assertThat(new Wrangler(shadowMap, 22).createShadowFor(new ChildOfDummyClass()))
        .isSameAs(Wrangler.NO_SHADOW);
  }
  ...
  public void whenChildShadowHasNarrowerSdk_shouldCallAppropriateShadowMethod() throws Exception {
    ...
    assertThat(new Wrangler(shadowMap, 19).methodInvoked(methodName, false, ChildOfDummyClass.class))
        .isNull();
    assertThat(new Wrangler(shadowMap, 20).methodInvoked(methodName, false, ChildOfDummyClass.class).describe())
        .contains("ShadowChildOfDummyClass.methodWithoutRange()");
    assertThat(new Wrangler(shadowMap, 21).methodInvoked(methodName, false, ChildOfDummyClass.class).describe())
        .contains("ShadowChildOfDummyClass.methodWithoutRange()");
  }
  ...
  private class Wrangler extends ShadowWrangler {
    public Wrangler(ShadowMap shadowMap, int apiLevel) {
      super(shadowMap, apiLevel, AndroidInstrumentationConfigurer.getMethodCallHandlers());
    }
  }
