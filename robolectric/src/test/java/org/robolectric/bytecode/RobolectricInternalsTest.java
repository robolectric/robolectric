...
public class RobolectricInternalsTest {
  ...
  public void getConstructor_withOneStringParam() {
    ...
    Shadow.invokeConstructor(Constructors.class, a, new ReflectionHelpers.StringParameter("java.lang.String", PARAM1));
  ...
  public void getConstructor_withOneClassParam() {
    ...
    Shadow.invokeConstructor(Constructors.class, a, new ReflectionHelpers.ClassParameter(String.class, PARAM1));
    assertThat(a.param11).isEqualTo(PARAM1);
  }
