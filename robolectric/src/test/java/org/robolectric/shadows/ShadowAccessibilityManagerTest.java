...
public class ShadowAccessibilityManagerTest {
  ...
  public void sendAccessibilityEvent() {
    shadowOf(accessibilityManager).setEnabled(true);
    assertThat(shadowOf(accessibilityManager).getLastAccessibilityEvent()).isNull();

    AccessibilityEvent event = AccessibilityEvent.obtain(AccessibilityEvent.TYPE_VIEW_FOCUSED);
    accessibilityManager.sendAccessibilityEvent(event);

    assertThat(shadowOf(accessibilityManager).getLastAccessibilityEvent()).isEqualTo(event);
  }
