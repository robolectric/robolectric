...
public class CallDetailsBuilderTest {
  ...
  public void newBuilder_setsAllFields() {
    ...
    extras.putString("test_key", "test_val");
    ...
    assertThat(details.getExtras().getString("test_key")).isEqualTo("test_val");
  }
  ...
  public void newBuilder_copyConstructor_preservesAllFields() {
    ...
    assertThat(copiedDetails.getExtras().getString("test_key")).isEqualTo("test_val");
  }
