...
public class ResourceHelperTest {
  ...
  public void parseFloatAttribute_attributeNull_unitNotRequired_validValue_endingWithSpaces() {
    ...
    validateTypedValue(out, 0, null, TypedValue.TYPE_FLOAT, Float.floatToIntBits(result), result);
  }
  ...
  public void parseFloatAttribute_attributeNull_unitNotRequired_negativeFloatValue_withUnit() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(out, 0, null, TypedValue.TYPE_DIMENSION, -10317792, -3.0115387e38f);
  }
  ...
  public void parseFloatAttribute_attributeNull_unitNotRequired_negativeSmallFloatValue_withUnit() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(out, 0, null, TypedValue.TYPE_DIMENSION, -493921231, -1.3222637e21f);
  }
  ...
  public void parseFloatAttribute_attributeNull_unitNotRequired_positiveFloatValue_withUnit() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(out, 0, null, TypedValue.TYPE_DIMENSION, 10317858, 1.4458399e-38f);
  }
  ...
  public void parseFloatAttribute_attributeNull_unitNotRequired_positiveSmallFloatValue_withUnit() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(out, 0, null, TypedValue.TYPE_DIMENSION, 493921331, 3.1848625e-21f);
  }
  ...
  public void parseFloatAttribute_attributeNull_unitNotRequired_negativeIntValue_withUnit() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(out, 0, null, TypedValue.TYPE_DIMENSION, -31484, Float.NaN);
  }
  ...
  public void parseFloatAttribute_attributeNull_unitNotRequired_positiveIntValue_withUnit() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(out, 0, null, TypedValue.TYPE_DIMENSION, 31493, 4.4131e-41f);
  }
  ...
  public void parseFloatAttribute_attributeNull_unitRequired_validValue_endingWithSpaces() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(out, 0, null, TypedValue.TYPE_DIMENSION, -10317791, -3.0115389e38f);
  }
  ...
  public void parseFloatAttribute_attributeNull_unitRequired_positiveFloatValue() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(out, 0, null, TypedValue.TYPE_DIMENSION, 10317857, 1.4458397e-38f);
  }
  ...
  public void parseFloatAttribute_attributeNull_unitRequired_positiveSmallFloatValue() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(out, 0, null, TypedValue.TYPE_DIMENSION, 493921329, 3.184862e-21f);
  }
  ...
  public void parseFloatAttribute_attributeNull_unitRequired_negativeIntValue() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(out, 0, null, TypedValue.TYPE_DIMENSION, -31487, Float.NaN);
  }
  ...
  public void parseFloatAttribute_attributeNull_unitRequired_positiveIntValue() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(out, 0, null, TypedValue.TYPE_DIMENSION, 31489, 4.4125e-41f);
  }
  ...
  public void parseFloatAttribute_lengthEquals1000_parseSucceed() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(
        out, 0, null, TypedValue.TYPE_FLOAT, Float.floatToIntBits(Float.parseFloat(input)), 0.16f);
  }
  ...
  public void parseFloatAttribute_lengthLessThan1000_parseSucceed() {
    ...
    assertThat(parseResult).isTrue();
    validateTypedValue(
        out, 0, null, TypedValue.TYPE_FLOAT, Float.floatToIntBits(Float.parseFloat(input)), 0.18f);
  }
  ...
  public void parseFloatAttribute() {
    String input = "0.16";
    TypedValue out = new TypedValue();
    ResourceHelper.parseFloatAttribute(null, input, out, false);
    validateTypedValue(
        out, 0, null, TypedValue.TYPE_FLOAT, Float.floatToIntBits(Float.parseFloat(input)), 0.16f);
  ...
  private void validateTypedValue(
      ...
      int data,
      float result) {
    assertThat(out.assetCookie).isEqualTo(assetCookie);
