...
public class ShadowDisplayManagerTest {
  ...
  public void displayManager_activityContext_retrievesDisplaysWithMultiWindow() {
    ...
    try {
      ...
      assertThat(applicationDisplays).isNotEmpty();
      assertThat(activityDisplays).isNotEmpty();
      ...
      for (Display mwDisplay : multiWindowDisplays) {
        ...
        System.out.println("Multi-window dimensions: " + mwWidth + "x" + mwHeight);
      }
  ...
  private void setMultiWindowMode(Activity activity, boolean enabled) {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
      ...
      activity.onMultiWindowModeChanged(enabled);
      ...
      params.width = configuration.smallestScreenWidthDp * 2; // Simulate narrower window
      params.height = configuration.smallestScreenWidthDp; // Simulate shorter window
