...
public class ShadowTraceTest {
  ...
  public void beginSection_tagIsNullAndCrashDisabled_doesNotThrow() throws Exception {
    ShadowTrace.setCrashOnIncorrectUsage(false);
    Trace.beginSection(null);
    // Should not crash.
  }
  ...
  @Test
  public void endSection_calledBeforeBeginningAndCrashDisabled_doesNotThrowByDefault()
      throws Exception {
    ShadowTrace.setCrashOnIncorrectUsage(false);
  ...
  @Test
  public void endSection_oneSectionButCalledTwiceAndCrashDisabled_doesNotThrowByDefault()
      throws Exception {
    ShadowTrace.setCrashOnIncorrectUsage(false);
