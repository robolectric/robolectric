...
public class ShadowAccountManagerTest {
  ...
  @Config(minSdk = O)
  public void
      accountManager_activityContextEnabled_applicationInstanceIsNotSameAsActivityInstance() {
  ...
  @Test
  @Config(minSdk = O)
  public void accountManager_activityContextEnabled_activityInstanceIsSameAsActivityInstance() {
    String originalProperty = System.getProperty("robolectric.createActivityContexts", "");
    System.setProperty("robolectric.createActivityContexts", "true");
    try {
      Activity activity = Robolectric.setupActivity(Activity.class);
      ...
      AccountManager anotherActivityAccountManager =
          activity.getSystemService(AccountManager.class);
