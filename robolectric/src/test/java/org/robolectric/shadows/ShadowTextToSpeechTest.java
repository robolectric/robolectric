...
public class ShadowTextToSpeechTest {
  ...
  @Test
  @Config(minSdk = LOLLIPOP)
  public void synthesizeToFile_paramsStored() {
    ...
    assertThat(shadowOf(textToSpeech).getLastSynthesizeText()).isEqualTo("text");
    assertThat(shadowOf(textToSpeech).getLastSynthesizeParams()).isEqualTo(bundle);
    assertThat(shadowOf(textToSpeech).getLastSynthesizeFile()).isEqualTo(file);
    assertThat(shadowOf(textToSpeech).getLastSynthesizeUtteranceId()).isEqualTo("id");
  }

  @Test
  @Config(minSdk = LOLLIPOP)
  public void synthesizeToFile_neverCalled_paramsNull() {
    assertThat(shadowOf(textToSpeech).getLastSynthesizeText()).isNull();
    assertThat(shadowOf(textToSpeech).getLastSynthesizeParams()).isNull();
    assertThat(shadowOf(textToSpeech).getLastSynthesizeFile()).isNull();
    assertThat(shadowOf(textToSpeech).getLastSynthesizeUtteranceId()).isNull();
  }
  ...
  @Test
  @Config(minSdk = LOLLIPOP)
  public void speak_withUtteranceId_lastSpeakUtteranceIdStored() {
    textToSpeech.speak("Hello", TextToSpeech.QUEUE_FLUSH, null, "TTSEnable");
    assertThat(shadowOf(textToSpeech).getLastSpeakUtteranceId()).isEqualTo("TTSEnable");
  }

  @Test
  @Config(minSdk = LOLLIPOP)
  public void speak_withParams_lastSpeakParamsStored() {
    Bundle params = new Bundle();
    textToSpeech.speak("Hello", TextToSpeech.QUEUE_FLUSH, params, "TTSEnable");
    assertThat(shadowOf(textToSpeech).getLastSpeakParams()).isEqualTo(params);
  }

  @Test
  @Config(minSdk = LOLLIPOP)
  public void getLastSpeakUtteranceId_neverStored_returnsNull() {
    assertThat(shadowOf(textToSpeech).getLastSpeakUtteranceId()).isNull();
  }

  @Test
  @Config(minSdk = LOLLIPOP)
  public void getLastSpeakParams_neverStored_returnsNull() {
    assertThat(shadowOf(textToSpeech).getLastSpeakParams()).isNull();
  }
}
