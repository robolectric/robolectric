...
public class ShadowActivityTest {
  ...
  public void
      shouldNotComplainIfActivityIsDestroyedWhileAnotherActivityHasRegisteredBroadcastReceivers()
          throws Exception {
    try(ActivityController<DialogCreatingActivity> controller = Robolectric.buildActivity(DialogCreatingActivity.class)) {
      activity = controller.get();
  ...
  public void startActivityForResultAndReceiveResult_whenNoIntentMatches_shouldThrowException() {
    try (ActivityController<ThrowOnResultActivity> controller = Robolectric.buildActivity(ThrowOnResultActivity.class)) {
  ...
  public void getActionBar_shouldWorkIfActivityHasAnAppropriateTheme() {
    try(ActivityController<ActionBarThemedActivity> controller = Robolectric.buildActivity(ActionBarThemedActivity.class)) {
  ...
  public void buildActivity_noOptionsBundle_launchesOnDefaultDisplay() {
    try(ActivityController<Activity> controller = Robolectric.buildActivity(Activity.class, null)) {
  ...
  public void buildActivity_optionBundleWithNoDisplaySet_launchesOnDefaultDisplay() {
    try(ActivityController<Activity> controller = Robolectric.buildActivity(Activity.class, null, ActivityOptions.makeBasic().toBundle())) {
      Activity activity = controller.setup().get();
