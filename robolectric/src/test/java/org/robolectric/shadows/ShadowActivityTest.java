...
public class ShadowActivityTest {
  ...
  public void simulateGetDirectActions_succeeds() throws Exception {
    ...
    shadowOf(testActivity).simulateGetDirectActions(testConsumer);
  }

  @Test
  @Config(minSdk = VERSION_CODES.S)
  public void simulateGetDirectActions_malformedDirectAction_fails() throws Exception {
    ActivityController<TestActivity> controller = Robolectric.buildActivity(TestActivity.class);
    TestActivity testActivity = controller.setup().get();
    ...
    assertThrows(
        ...
        () -> {
          shadowOf(testActivity).simulateGetDirectActions((unused) -> {});
        });
  }
