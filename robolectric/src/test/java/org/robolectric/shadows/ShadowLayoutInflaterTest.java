...
public class ShadowLayoutInflaterTest {
  ...
  public void testFindsChildrenById() throws Exception {
    ...
    assertThat(mediaView.<TextView>findViewById(R.id.title)).isInstanceOf(
        (Class<? extends TextView>) TextView.class);
    ...
    assertThat(mainView.<View>findViewById(R.id.title)).isInstanceOf(
        (Class<? extends View>) View.class);
  }
  ...
  public void testInflatingConflictingSystemAndLocalViewsWorks() throws Exception {
    ...
    assertThat(view.<ImageView>findViewById(R.id.icon)).isInstanceOf(
        (Class<? extends ImageView>) ImageView.class);
    ...
    assertThat(view.<ImageView>findViewById(android.R.id.icon)).isInstanceOf(
        (Class<? extends ImageView>) ImageView.class);
  }
  ...
  public void testInclude() throws Exception {
    ...
    assertThat(mediaView.<TextView>findViewById(R.id.include_id)).isInstanceOf(
        (Class<? extends TextView>) TextView.class);
  }
  ...
  public void shouldRetainIdOnIncludedMergeWhenIncludeSpecifiesNoId() throws Exception {
    ...
    ViewGroup mediaView = (ViewGroup) LayoutInflater.from(context).inflate(layoutResId, null);
    assertThat(mediaView.<TextView>findViewById(R.id.inner_text)).isInstanceOf(
        (Class<? extends TextView>) TextView.class);
  }
  ...
  public void shouldRetainIdOnIncludedNonMergeWhenIncludeSpecifiesNoId() throws Exception {
    int layoutResId = context.getResources().getIdentifier("override_include", "layout", TEST_PACKAGE);
    ViewGroup mediaView = (ViewGroup) LayoutInflater.from(context).inflate(layoutResId, null);
    assertThat(mediaView.<TextView>findViewById(R.id.snippet_text)).isInstanceOf(
        (Class<? extends TextView>) TextView.class);
  }
  ...
  public void testIncludedIdShouldNotBeFoundWhenIncludedIsMerge() throws Exception {
    ...
    assertThat(overrideIncludeView.<LinearLayout>findViewById(R.id.outer_merge)).isInstanceOf(
        (Class<? extends LinearLayout>) LinearLayout.class);
    assertThat(overrideIncludeView.<TextView>findViewById(R.id.inner_text)).isInstanceOf(
        (Class<? extends TextView>) TextView.class);
