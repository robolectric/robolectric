...
public class ShadowAlarmManagerTest {
  ...
  public void setRepeating_shouldRegisterAlarm() {
    assertThat(shadowAlarmManager.getNextScheduledAlarm()).isNull();
    alarmManager.setRepeating(AlarmManager.ELAPSED_REALTIME, 0, INTERVAL_HOUR, PendingIntent.getActivity(activity, 0, new Intent(activity, activity.getClass()), 0));
    assertThat(shadowAlarmManager.getNextScheduledAlarm()).isNotNull();
  }
  ...
  public void cancel_removesMatchingPendingIntents() {
    ...
    PendingIntent pendingIntent2 = PendingIntent.getBroadcast(context, 0, intent2, FLAG_UPDATE_CURRENT);
    ...
    PendingIntent pendingIntent3 = PendingIntent.getBroadcast(context, 0, intent3, FLAG_UPDATE_CURRENT);
