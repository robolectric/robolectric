...
public class ParallelUniverseTest {
  ...
  private static Config getDefaultConfig() {
    return new Config.Implementation(new int[0], Config.DEFAULT, "", "org.robolectric", "res", "assets", new Class[0], new Class[0], new String[0], Application.class, new String[0], null);
  }
  ...
  public void setUpApplicationState_setsVersionQualifierFromSdkConfig() {
    ...
    Config c = new Config.Implementation(new int[0], Config.DEFAULT, givenQualifiers, "org.robolectric", "res", "assets", new Class[0], new Class[0], new String[0], Application.class, new String[0], null);
  ...
  public void setUpApplicationState_setsVersionQualifierFromSdkConfigWithOtherQualifiers() {
    ...
    Config c = new Config.Implementation(new int[0], Config.DEFAULT, givenQualifiers, "res", "assets", "", new Class[0], new Class[0], new String[0], Application.class, new String[0], null);
    pu.setUpApplicationState(null, new DefaultTestLifecycle(), null, null, c);
