...
public class SimulatorClassLoader extends AndroidSandbox.SdkSandboxClassLoader {
  ...
  private final ResourceProvider extraResourceProvider;
  ...
  public SimulatorClassLoader(
    ...
    extraResourceProvider = new UrlResourceProvider(jarCollection.getUrls());
  }

  @Override
  protected byte[] getByteCode(String className) throws ClassNotFoundException {
    String classFilename = className.replace('.', '/') + ".class";
    try (InputStream classBytesStream = extraResourceProvider.getResourceAsStream(classFilename)) {
