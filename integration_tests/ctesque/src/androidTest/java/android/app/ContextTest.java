...
public class ContextTest {
  ...
  public void
      registerReceiver_withoutAnyExportedFlagsAndTargetSdkLargerThan33_throwsSecurityException() {
  ...
  @Test
  @SdkSuppress(minSdkVersion = Build.VERSION_CODES.UPSIDE_DOWN_CAKE)
  public void registerReceiver_withReceiverExportedFlagAndTargetSdkLargerThan33_succeed() {
    IntentFilter filter = new IntentFilter(DownloadManager.ACTION_DOWNLOAD_COMPLETE);
  ...
  @Test
  @SdkSuppress(minSdkVersion = Build.VERSION_CODES.UPSIDE_DOWN_CAKE)
  public void registerReceiver_withReceiverNotExportedFlagAndTargetSdkLargerThan33_succeed() {
    IntentFilter filter = new IntentFilter(DownloadManager.ACTION_DOWNLOAD_COMPLETE);
  ...
  @SdkSuppress(minSdkVersion = Build.VERSION_CODES.UPSIDE_DOWN_CAKE)
  public void
      registerReceiver_withBothExportedFlagsAndTargetSdkLargerThan33_throwsIllegalArgumentException() {
    IntentFilter filter = new IntentFilter(DownloadManager.ACTION_DOWNLOAD_COMPLETE);
    assertThrows(
  ...
  public void
      registerReceiver_withoutAnyExportedFlagsAndTargetLessThan34_notThrowsSecurityException() {
    IntentFilter filter = new IntentFilter(DownloadManager.ACTION_DOWNLOAD_COMPLETE);
    application.registerReceiver(new TestBroadcastReceiver(), filter);
  }
