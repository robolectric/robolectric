// BEGIN-INTERNAL
// refers to internal Intento name
package org.robolectric.integration_tests.axt;

import static androidx.test.InstrumentationRegistry.getTargetContext;
import static androidx.test.espresso.intent.Intento.getIntents;
...
import androidx.test.espresso.intent.Intento;
...
public class IntentoTest {
  ...
  public void testNoIntents() {
    Intento.assertNoUnverifiedIntents();
  }

  @Test
  public void testIntendedFailEmpty() {
    try {
      Intento.intended(org.hamcrest.Matchers.any(Intent.class));
  ...
  public void testIntendedSuccess() {
    ...
    Intento.intended(hasAction(Intent.ACTION_VIEW));
  }
  ...
  public void testIntendedNotMatching() {
    ...
    getTargetContext().startActivity(i);
    try {
      Intento.intended(hasAction(Intent.ACTION_AIRPLANE_MODE_CHANGED));
    } catch (AssertionError e) {
      // expected
      return;
    }
