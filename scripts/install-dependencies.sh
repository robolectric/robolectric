...
mvn dependency:get -DgroupId=org.robolectric -DartifactId=android-all -Dversion=5.0.0_r2-robolectric-1 -Dpackaging=jar -DremoteRepositories=https://oss.sonatype.org/content/groups/public/
