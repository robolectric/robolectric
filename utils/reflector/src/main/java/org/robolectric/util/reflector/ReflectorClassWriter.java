...
class ReflectorClassWriter extends ClassWriter {
    ...
    void write() {
      ...
      if (fieldRefs.add(targetFieldName)) {
        visitField(ACC_PRIVATE | ACC_STATIC,
            fieldRefName, FIELD_TYPE.getDescriptor(), null, null);
      }
  ...
  private class ReflectorMethodWriter extends GeneratorAdapterAdapter {
    ...
    private ReflectorMethodWriter(Method method) {
      super(method);
      this.iMethod = method;
      this.methodRefName = "method" + (nextMethodNumber++);
    ...
    void write() {
      ...
      visitField(ACC_PRIVATE | ACC_STATIC,
          methodRefName, METHOD_TYPE.getDescriptor(), null, null);
  ...
  private class GeneratorAdapterAdapter extends GeneratorAdapter {
    ...
    private GeneratorAdapterAdapter(Method method, org.objectweb.asm.commons.Method asmMethod) {
    ...
    private GeneratorAdapterAdapter(Method method, org.objectweb.asm.commons.Method asmMethod,
      ...
      super(Opcodes.ASM6, methodVisitor, Opcodes.ACC_PUBLIC, asmMethod.getName(),
          asmMethod.getDescriptor());
    }
