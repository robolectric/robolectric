...
public class ReflectorTest {
  ...
  public void reflector_shouldUnboxReturnValues() throws Exception {
    assertThat(reflector.returnLong())
        .isEqualTo(1234L);
  }

  @Test
  public void reflector_fieldAccessors() throws Exception {
    assertThat(reflector.getC())
        .isEqualTo("c");
  ...
  private String methodByReflectionHelpers(SomeClass o) {
    return ReflectionHelpers.callInstanceMethod(o, "someMethod",
