...
public class ClassInstrumentorTest {
  ...
  public void instrumentConstructor_withParameterSlotReuse_doesNotSplit()
    ...
    // Define the class so there are no VerifyErrors
    byte[] instrumented = instrumentor.instrumentToBytes(clazz);
    MethodHandles.lookup().defineClass(instrumented);
    ...
    String directCtorName =
        Shadow.directMethodName(
            "org.robolectric.internal.bytecode.SlotReuseCtor", "__constructor__");
  ...
  public void instrumentConstructor_withoutParameterSlotReuse_doesSplit()
    ...
    String directCtorName =
        Shadow.directMethodName("org.robolectric.internal.bytecode.NormalCtor", "__constructor__");
    MethodNode directCtor =
        Iterables.tryFind(classNode.methods, m -> m.name.equals(directCtorName)).orNull();
  ...
  private static ClassNode createClassWithSlotReusingConstructor() {
    ...
    cw.visit(
        Opcodes.V1_7,
        Opcodes.ACC_PUBLIC,
        "org/robolectric/internal/bytecode/SlotReuseCtor",
        null,
        "java/lang/Object",
        null);
    ...
    ClassNode classNode = new ClassNode();
    new ClassReader(cw.toByteArray()).accept(classNode, 0);
    return classNode;
  }
  ...
  private static ClassNode createClassWithNormalConstructor() {
    ...
    cw.visit(
        Opcodes.V1_7,
        Opcodes.ACC_PUBLIC,
        "org/robolectric/internal/bytecode/NormalCtor",
        null,
        "java/lang/Object",
        null);
    cw.visitField(Opcodes.ACC_PRIVATE, "f", "Ljava/lang/String;", null, null).visitEnd();
