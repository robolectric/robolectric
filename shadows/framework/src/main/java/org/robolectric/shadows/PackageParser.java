...
public class PackageParser {
   ...
   * @throws IOException
   */
  public Package parseBaseApk(String apkPath, Resources res, XmlResourceParser parser, int flags,
  ...
  private static String buildProcessName(String pkg, String defProc,
    ...
    return null;//TextUtils.safeIntern(buildCompoundName(pkg, procSeq, "process", outError));
  }
  ...
  private boolean parsePermission(Package owner, Resources res,
    ...
    if ((perm.info.protectionLevel&PermissionInfo.PROTECTION_MASK_FLAGS) != 0) {
      if ( (perm.info.protectionLevel&PermissionInfo.PROTECTION_FLAG_RUNTIME_ONLY) == 0
