 ...
 *
 * In {@link LooperMode.Mode.PAUSED} mode, Robolectric maintains its own concept of the current time
 * from the Choreographer's point of view, aimed at making animations work correctly. Time starts
 * out at {@code 0} and advances by {@code frameInterval} every time
