...
public class ShadowTelecomManager {
  ...
  /** Details about an outgoing call request made via {@link TelecomManager#addNewIncomingCall}. */
  ...
  /** Details about an outgoing call request made via {@link TelecomManager#addNewUnknownCall}. */
