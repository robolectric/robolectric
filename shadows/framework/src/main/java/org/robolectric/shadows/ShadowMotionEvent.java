...
public class ShadowMotionEvent {
  ...
  /**
   * @deprecated use {@link MotionEvent#obtain} or
   *   {@link androidx.test.core.view.MotionEventBuilder#setPointerAction(int, int)} to create a MotionEvent with desired data.
   */
  @Deprecated
