...
public class ShadowContentProviderClient {
  ...
  @Implementation
  protected void __constructor__(ContentResolver contentResolver, IContentProvider contentProvider, boolean stable) {
    this.stable = stable;
  }
  ...
  @Implementation
  protected Cursor query(Uri url, String[] projection, String selection, String[] selectionArgs,
  ...
  @Implementation
  protected int delete(Uri url, String selection, String[] selectionArgs)
  ...
  @Implementation
  protected final AssetFileDescriptor openTypedAssetFileDescriptor(Uri uri,
