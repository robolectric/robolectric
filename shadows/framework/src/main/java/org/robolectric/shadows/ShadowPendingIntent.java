...
public class ShadowPendingIntent {
  ...
  /**
   * Calls {@link PendingIntent.OnFinished#onSendFinished} on the last
   * {@link PendingIntent.OnFinished} passed with {@link #send()}.
   *
   ...
   * thread.
   *
   * @return false if no {@link PendingIntent.OnFinished} callback was passed with the last
   * {@link #send()} call, true otherwise.
   */
