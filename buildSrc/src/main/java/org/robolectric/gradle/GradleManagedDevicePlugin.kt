...
class GradleManagedDevicePlugin : Plugin<Project> {
  override fun apply(project: Project) {
    ...
    androidExtension.testOptions {
      ...
      managedDevices {
        ...
        // ./gradlew -Pandroid.sdk.channel=3 nexusOneApi36DebugAndroidTest
        localDevices.register(NAME_API_36) {
          device = "Nexus One"
          apiLevel = 36
          systemImageSource = "aosp-atd"
        }
        ...
        groups.register("nexusOneIntegrationTestGroup") {
          ...
          targetDevices.add(allDevices[NAME_API_36])
        }
      } // managedDevices
    } // testOptions
  } // apply
  ...
  private companion object {
    ...
    private const val NAME_API_36 = "nexusOneApi36"
  }
}
